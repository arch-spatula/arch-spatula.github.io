...
## 주간 회고: WIL.23.01.15. - 기본까지 아직도 먼 길입니다
...
- 크롬에도 vim을 설치했습니다. 답답한 마우스 스크롤링을 안할 수 있게 되었습니다.
...
- 개발자에게 2가지 기본언어가 있으면 하나는 C언어이고 다른 하나는 영어입니다.
  - C언어로 하이레벨로 구현했던 자료구조와 알고리즘을 모두 다시 구현합니다.
