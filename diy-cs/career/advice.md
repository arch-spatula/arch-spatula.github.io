...
- 꽤나 유명해진 글 같습니다. 위 5가지에 대해서 아래와 같이 설명합니다. 저의 의견을 주자면 대부분은 동의 안하고 몇개만 동의합니다.
  - 운동선수들이 새로운 운동을 시도하는 것처럼, 우리의 커리어도 성장하기 위해 변화가 필요합니다. 만약 현재의 일이 더 이상 나를 성장시키지 않는다고 느낀다면, 환경을 바꾸는 것이 좋습니다. 조금의 변화를 통해 성장할 수 없다면, 새로운 환경을 찾아보는 것도 좋은 방법입니다.
    - 저의 의견: 본인의 성장은 본인의 책임입니다. 일이 본인을 성장시킬 수 있으면 좋습니다. 하지만 회사 본인을 성장시킬 수준의 업무 난이도를 안 준다면 본인을 돌아봐야 합니다. 해결할 문제가 별로 없는 회사면 떠나는 것이 좋습니다. 하지만 난이도 있는 문제를 해결할만큼 본인의 실력이 되는가? 아니면 그 실력을 최소한 조직에 증명했는가?
  - 하버드 석학들은 '박수칠 때 떠나라'는 말을 지지합니다. 일이 더 이상 도전적으로 느껴지지 않고, 이루고자 하는 바가 없다면, 새로운 도전을 찾아 떠나는 것이 좋습니다. 하지만 아직 이루고 싶은 목표가 있다면, 조금 더 버티는 것도 방법입니다.
    - 저의 의견: 이루고자 하는 것이 없어서 지금 그 실력과 그 성과밖에 없는 것입니다. 이루고자하는 것도 못찾으면 조직을 바꿔도 못찾을 것입니다. 지금 있는 조직에서 부터 성과을 목표로 잘 이룰 줄 알아야 합니다.
  - 해야 할 일을 미루고 다른 일을 먼저 하고 있다면, 이는 일을 관둘 때가 되었음을 의미합니다. 자꾸 미루는 습관이 생기면 일에 몰입하기 어려워집니다. 이럴 때는 차라리 그만두고 휴식을 취하는 것이 좋습니다.
    - 저의 의견: 해야할 일을 미루는 것은 본인 우선순위 실력이 문제입니다. 해야할 중요한 일이 있는데 미루는 것은 본인이 실력 없는 것입니다. 상황파악이 전혀 안되는 사람입니다.
  - 조직의 분위기가 나의 가치관과 맞지 않아 거짓말을 하거나 타인을 기만하게 된다면, 이는 심각한 문제입니다. 나의 가치관을 부정하게 만드는 조직에서는 더 이상 머무를 필요가 없습니다. 
    - 저의 의견: 지금은 어린이가 아닙니다. 어른이 되었고 직업입니다. 당신은 당신의 가치관으로 돈받는게 아닙니다. 당신은 당신이 만들어내고 끌어올리는 기업가치로 돈을 받는 것입니다. 가치관같은 어린이들이나 원하는 거 바라고 있을 때가 아닙니다. 지금 바래야 할 것은 성과입니다. 조직에 무슨 부조리가 있다고 해서 적응못하는 것은 본인만 해당하는 일입니다.
  - 건강이 망가질 정도로 일을 하거나, 모욕적인 동료가 있는 조직에서 일하는 것은 옳지 않습니다. 출근길마다 공포를 느낀다면 그만두는 것이 맞습니다. 자신을 자책하지 말고, 더 나은 환경을 찾아 떠나세요. 인생은 짧고, 우리의 삶은 아름답습니다.
    - 저의 의견: 건강이 망가질정도로 일 못하는지부터 의심하기 바랍니다. 사람이 어느정도 늘 자책감을 갖고 살아야 성장합니다. 얼마나 일을 못하고 있기 때문에 일 때문에 건강이 망가지는가? 이질문부터 하기바랍니다. 또 본인의 건강은 본인의 책임이지 지금 회사의 책임으로 돌리려는 것 아닌가? 비겁하게 변명하지말고 본인관리부터 잘하기 바랍니다. 
...
> 진짜 1인분은 1.2인분입니다. 본인 작업 1하고 남 돕는 작업 0.2입니다.

- [진정한 1인분의 의미: 협업과 책임의 중요성](https://www.youtube.com/watch?v=1dHD4aBXO24)에서 다룹니다.
