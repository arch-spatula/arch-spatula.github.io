...
유튜브에서 보는 개발자 직무전환자는 생존편향을 갖고 있습니다. 그중에 당신이 포함될거라는 생각만큼 무모하고 무리한 것은 없습니다.
...
- 학벌: 최소 인서울권 성적의 대학교(서울권이 아니지만 실력 인정: 카이스트, 포항공대)
...
- 입학 난이도가 높은 보안 부트캠프입니다.

[애플 아카데미](https://developeracademy.postech.ac.kr/)

- 포항공대에서 기숙하고 1년동안 ios개발자로 공부합니다.
...
[K - Shield](https://www.kshieldjr.org/)

- 표면상 보안을 다룬다고 하고 실제로는 프론트엔드 Java 백엔드 양성하는 부트캠프입니다.
- 보안 소프트웨어 개발자를 양성하는 과정이라고 하면 뭐 생각해볼 수 있는데 여기는 해당사항이 없습니다.
