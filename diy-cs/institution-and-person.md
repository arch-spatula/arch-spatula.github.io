...
<iframe className="codepen" src="https://www.youtube.com/embed/7TycxwFmdB0" title="앨런 튜링 : 컴퓨터 과학 특강 # 15" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>

- 컴퓨터의 아버지로 통합니다. ~~컴퓨터를 2차 세계 대전에 낳았으니 기계식 컴퓨터는 베이비 부머인가?~~
  ...
  - 독일의 Enigma를 해독했습니다.
    ...
    - 그래서 알고있는 것을 들키지 않기 위해 연기해야 하기 때문에 이미테이션 게임입니다. 하지만 들키지 않기 위해 연기하는 것은 첩보만이 아니었습니다.
...
### 마거릿 히필드 해밀턴(Margaret Heafield Hamilton, 1936년 8월 17일 ~)

![](/img/doc/diy-cs/institution-and-person/Margaret_Hamilton_-_restoration.jpg)

<iframe className="codepen" src="https://www.youtube.com/embed/kYCZPXSVvOQ" title="NASA’s first software engineer: Margaret Hamilton - Matt Porter & Margaret Hamilton" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>

- [관련 위키](https://ko.wikipedia.org/wiki/%EB%A7%88%EA%B1%B0%EB%A6%BF_%ED%95%B4%EB%B0%80%ED%84%B4_(%EA%B3%BC%ED%95%99%EC%9E%90))는 생각보다 깊게 다루지는 않습니다.
- 중요한 업적은 컴퓨터의 하드웨어와 소프트웨어를 구분했다는 것입니다.
  - 소프트웨어를 탄생시키고 어떤 관점에서 프로그래밍에 있어서 최초의 추상화입니다.
  - 나사는 어쎔블리를 작성하기 시작했습니다. ~~지금은 C 언어를 힙할당을 금지하고 사용하고 있는 것 같습니다.~~
- 유일하게 업근할 사람은 아닙니다.  상호교차성(흑인이면서 여성) 제약을 가졌지만 계산원으로서 기여자 또한 존재했습니다.

<iframe className="codepen" src="https://www.youtube.com/embed/PqURzqvCMss" title="히든 피겨스" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>

- 1960년대는 냉전시대이고 당시 우주경쟁 중이었습니다.
...
- 다익스트라 최단경로 알고리즘으로 유명합니다. 물론 유일한 업적은 아닙니다.
...
### 비야네 스트롭스트룹(Bjarne Stroustrup, 1950년 12월 30일 ~)

![](/img/doc/diy-cs/institution-and-person/Bjarne-stroustrup_(cropped).jpg)

- C++를 창시한 사람입니다.
  - 엄청나게 영향력있는 언어를 창시한 사랍입니다. 
  - 지금은 백악관이 없야하는 해로운 언어라고 하지만 아마 지금도 새로운 프로젝트들도 계속 C++을 고수할 것입니다.
  - 소문에 의하면 vim 유저이고 해피해킹을 사용한다고 합니다. ~~이것으로 제 리스팩은 얻었습니다.~~
...
- ~~우리나라 개발자들이 최애 회사입니다.~~
  ...
  - ~~유료 강의 사이트에 자바스크립트를 이름에 포함하면 고소로 선한 영향력을 펼치고 있습니다.~~

### 구글

- 그 거대한 규모의 개발자를 모아두고 모노레포를 사용한다는 전설이 있습니다.
  - ~~자동완성(LSP)연결까지 20분 걸린다고 합니다.~~
- 새로운 POC 용 프로젝트도 성능이 중요한게 아닌데도 C++를 고집하는 장인정신으로 가득합니다.
